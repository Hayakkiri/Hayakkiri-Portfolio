...
function Contact() {
  ...
  return (
    <section id="contact-section" className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/30 py-12 sm:py-16 md:py-20 lg:py-24 relative overflow-hidden">
      {/* Background Pattern */}
                  ...
                  >
                    {contact.link ? (
                      <a href={contact.link} className="flex items-center space-x-4">
                        <div className={`p-3 rounded-full bg-gradient-to-r ${contact.color} text-white`}>
                          {contact.icon}
                        </div>
                        <div>
                  ...
                  <div className="p-4 bg-green-500/20 border border-green-400/50 rounded-lg">
                    <div className="text-center">
                      ...
                      <p className="text-green-600 text-sm">
                        Thank you for reaching out. I'll get back to you within 24 hours at {submittedEmail}.
                      </p>
                    </div>
                  </div>
                )}
                ...
                {submitStatus === 'config_error' && (
                  <div className="p-4 bg-yellow-500/20 border border-yellow-400/50 rounded-lg">
                    <p className="text-yellow-600 text-center text-sm">
                      EmailJS is not configured yet. Please check the EMAILJS_SETUP.md file for setup instructions.
                      <br />
                      <span className="text-xs mt-1 block">
                        For now, you can reach me directly at: 
                        <a href="mailto:mhayakkiri@gmail.com" className="text-blue-600 hover:underline ml-1">
