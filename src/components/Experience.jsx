...
import wheelsImage from '../assets/wheels.webp';
import thalirImage from '../assets/thalir_intern.webp';
import gkImage from '../assets/GK_intern.webp';
import harshaImage from '../assets/harsha_intern.webp';
  ...
  return (
    ...
    style={{ transitionDelay: `${baseDelay}ms` }}>
      <div className={`flex flex-col lg:flex-row gap-6 sm:gap-8 lg:gap-12 items-center ${
        ...
        {/* Image Section */}
        <div className={`w-full sm:w-3/4 md:w-2/3 lg:w-1/2 transform transition-all duration-1000 ${
          isVisible 
            ? (isEven ? 'translate-x-0' : 'translate-x-0') + ' opacity-100'
            : (isEven ? '-translate-x-10' : 'translate-x-10') + ' opacity-0'
        }`}
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white p-2 sm:p-3 md:p-4 rounded-2xl shadow-xl group-hover:shadow-2xl transition-all duration-300">
              ...
              <div className={`absolute -top-2 -right-2 px-3 py-1 rounded-full text-xs font-semibold text-white shadow-lg ${
                ...
                {experience.type === 'work' ? 'Work Experience' : 'Internship'}
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Content Section */}
        <div className={`w-full lg:w-1/2 space-y-4 sm:space-y-5 md:space-y-6 transform transition-all duration-1000 ${
          isVisible 
            ? (isEven ? 'translate-x-0' : 'translate-x-0') + ' opacity-100'
            : (isEven ? 'translate-x-10' : '-translate-x-10') + ' opacity-0'
        }`}
        style={{ transitionDelay: `${baseDelay + 400}ms` }}>
          ...
          <div className="space-y-1 sm:space-y-2">
            ...
            <div className="flex items-center space-x-2 text-gray-500">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m-6 0V6a2 2 0 012-2h4a2 2 0 012 2v1m-6 0h12l-1 12a2 2 0 01-2 2H7a2 2 0 01-2-2L6 7z" />
              </svg>
          ...
          {experience.skills && (
            <div className="space-y-3">
              <h4 className="text-lg font-semibold text-gray-800">Key Skills & Technologies:</h4>
            ...
            <div className="flex items-center space-x-4 text-sm text-gray-600">
              <div className="flex items-center space-x-1">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-1 4h1m1-4h1" />
                </svg>
  ...
  const experiences = [
    {
      ...
      skills: ['Quality Control', 'Dimensional Verification', 'Precision Instruments', 'QC Documentation', 'SQA Standards'],
      image: wheelsImage
    },
    {
      type: 'work',
      ...
      description: 'Worked as assembly line operator in the Tandem Master Cylinder (TMC) department, assembling components to precise specifications and conducting functional testing to ensure working standards.',
      skills: ['Assembly Operations', 'Functional Testing', 'TMC Components', 'Quality Standards', 'Precision Assembly'],
      image: brakesImage
    },
    {
      type: 'internship',
      ...
      description: 'Learned knowledge in various stages of Special Purpose Machine (SPM) development at an automation company, learning about the intricacies of Departments Design, PPC, process, purchase, machine shop, quality control, assembly, and electrical aspects.',
      skills: ['SPM Development', 'Design Process', 'PPC', 'Quality Control', 'Assembly', 'Electrical Systems'],
      image: thalirImage
    },
    {
      type: 'internship',
      ...
      description: 'Enhanced expertise in operating Vertical Machining Centers (VMC) and Horizontal Machining Centers (HMC), focusing on tool setup and machining operations. Developed an understanding of lathe processing and tool usage.',
      skills: ['VMC Operation', 'HMC Operation', 'Tool Setup', 'Lathe Processing', 'Machining Operations'],
      image: harshaImage
    },
    {
      type: 'internship',
      ...
      department: 'Manufacturing / Core',
      description: 'Developed experience in basic CNC machine operation for precision manufacturing processes. Learned and performed machining operations on slotter machines to align the key on shafts.',
      skills: ['CNC Operation', 'Precision Manufacturing', 'Slotter Machines', 'Shaft Alignment', 'Key Alignment'],
      image: gkImage
    }
  ];

  return (
    <section id="experience-section" className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/30 py-12 sm:py-16 md:py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
          ...
          <div className={`text-center mb-12 md:mb-16 lg:mb-20 transform transition-all duration-1000 ${
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-xl text-gray-600 max-w-sm sm:max-w-lg md:max-w-2xl lg:max-w-3xl mx-auto mb-4 md:mb-6 px-4 leading-relaxed">
              My journey through various roles in quality control, manufacturing, and automation
            </p>
          ...
          {/* Summary Stats */}
          <div className={`mt-12 sm:mt-16 md:mt-20 lg:mt-24 grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6 lg:gap-8 transform transition-all duration-1000 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}
          style={{ transitionDelay: '1800ms' }}>
            <div className="text-center bg-white/80 backdrop-blur-sm rounded-xl p-4 sm:p-5 md:p-6 border border-gray-200/50 hover:shadow-lg transition-all duration-300">
              <div className="text-2xl sm:text-3xl md:text-3xl font-bold text-green-600 mb-1 sm:mb-2">2</div>
              <div className="text-gray-700 font-medium text-sm sm:text-base">Work Experiences</div>
            </div>
            <div className="text-center bg-white/80 backdrop-blur-sm rounded-xl p-4 sm:p-5 md:p-6 border border-gray-200/50 hover:shadow-lg transition-all duration-300">
              <div className="text-2xl sm:text-3xl md:text-3xl font-bold text-blue-600 mb-1 sm:mb-2">3</div>
              <div className="text-gray-700 font-medium text-sm sm:text-base">Internships</div>
            </div>
            <div className="text-center bg-white/80 backdrop-blur-sm rounded-xl p-4 sm:p-5 md:p-6 border border-gray-200/50 hover:shadow-lg transition-all duration-300">
              <div className="text-2xl sm:text-3xl md:text-3xl font-bold text-purple-600 mb-1 sm:mb-2">18+</div>
              <div className="text-gray-700 font-medium text-sm sm:text-base">Months Experience</div>
            </div>
            <div className="text-center bg-white/80 backdrop-blur-sm rounded-xl p-4 sm:p-5 md:p-6 border border-gray-200/50 hover:shadow-lg transition-all duration-300">
              <div className="text-2xl sm:text-3xl md:text-3xl font-bold text-orange-600 mb-1 sm:mb-2">5</div>
              <div className="text-gray-700 font-medium text-sm sm:text-base">Companies</div>
            </div>
          </div>
        </div>
      </section>
