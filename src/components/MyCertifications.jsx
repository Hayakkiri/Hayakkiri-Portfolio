...
function MyCertifications() {
  ...
  const certifications = [
    { id: 1, name: "Democracy Quiz Certificate", image: democracyQuizCert, issuer: "Civic Education" },
    { id: 2, name: "Bentley Certificate 1", image: bentley1Cert, issuer: "Bentley Systems" },
    { id: 3, name: "Bentley Certificate 2", image: bentley2Cert, issuer: "Bentley Systems" },
    { id: 4, name: "Bentley Certificate 3", image: bentley3Cert, issuer: "Bentley Systems" },
    { id: 5, name: "Cisco Networking Certificate", image: ciscoCert, issuer: "Cisco Systems" },
    { id: 6, name: "Thalir Certificate", image: thalir, issuer: "Thalir Automation" },
    { id: 7, name: "QC", image: harsha, issuer: "Harsha CNC" },
    { id: 8, name: "CNC Operator", image: gk, issuer: "GK Engineering" },
  ];
  ...
  return (
    <section id="certifications-section" className="min-h-screen bg-gradient-to-br from-blue-50/30 to-purple-50/30 py-20">
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className={`text-center mb-16 transform transition-all duration-1000 ${
          ...
          <div className={`w-24 h-1 bg-gradient-to-r from-blue-600 to-purple-600 mx-auto rounded-full transform transition-all duration-800 delay-200 ${
        ...
        <div className={`relative overflow-hidden transform transition-all duration-1000 delay-600 ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}>
          {/* Gradient Overlays */}
          <div className={`absolute left-0 top-0 w-20 h-full bg-gradient-to-r from-blue-50/80 to-transparent z-10 pointer-events-none transform transition-all duration-800 delay-700 ${
            isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'
          }`}></div>
          <div className={`absolute right-0 top-0 w-20 h-full bg-gradient-to-l from-purple-50/80 to-transparent z-10 pointer-events-none transform transition-all duration-800 delay-700 ${
            isVisible ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'
          }`}></div>
          ...
          <div 
            className={`flex space-x-8 transform transition-all duration-1000 delay-800 ${
              isVisible ? 'animate-scroll translate-y-0 opacity-100' : 'translate-y-5 opacity-0'
            }`}
          ...
          >
            {duplicatedCertifications.map((cert, index) => (
              <div
                ...
                style={{ 
                  transitionDelay: `${900 + (index % 8) * 100}ms` 
                }}
              >
                {/* Certificate Image Only */}
        ...
        <div className={`text-center mt-16 transform transition-all duration-1000 delay-1200 ${
          ...
          <p className={`text-gray-600 transform transition-all duration-800 delay-1300 ${
            isVisible ? 'scale-100 opacity-100' : 'scale-95 opacity-0'
          }`}>
            Hover over any certificate to pause the carousel and explore details
          </p>
        </div>
      </div>
