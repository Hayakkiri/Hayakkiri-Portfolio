...
import HayakkiriImage from "../assets/profile.jpg";
	...
	return (
		...
		>
			<nav className="flex items-center justify-between max-w-7xl mx-auto py-4 px-4 md:px-8">
				{/* Logo */}
				<div className="flex flex-row align-middle gap-0">
					<img
						src={logoImage}
						alt="Hayakkiri Logo"
					...
					<div className="grid lg:grid-cols-2 gap-16 items-center">
						...
						>
							...
							>
								...
								>
									I am a dedicated Mechatronics Engineering
									professional with practical experience in
									quality control and assembly line operations
									within the TVS Group. My roles at Brakes
									India and Wheels India involved precise
									assembly of Tandem Master Cylinder (TMC)
									components and dimensional verification of
									incoming materials, respectively. This
									experience has equipped me with a strong
								...
								>
									...
									QC tools, engineering drawing, GD&T,
									AutoCAD, and SolidWorks. I have foundational
									knowledge in CNC machine operation (VMC/HMC)
									and Special Purpose Machine (SPM)
									development from various internships. My
									passion for automation is evident in
									projects such as the Autonomous Rover, where
									I applied engineering principles to develop
									solutions for industrial surveillance.
								</p>
							</div>
