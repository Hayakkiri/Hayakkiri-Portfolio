      ...
      <div className="relative z-10 flex-1 flex items-center justify-center text-center px-4 md:px-6 max-w-5xl mx-auto">
        <div className="space-y-4 md:space-y-6">
          ...
          <div className="space-y-3 md:space-y-4 opacity-0 animate-fade-in-up animation-delay-900">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-4 text-sm sm:text-base md:text-lg lg:text-xl text-gray-300">
              <span className="px-3 sm:px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 hover:bg-white/20 hover:border-blue-400/50 transform hover:scale-105 transition-all duration-300 opacity-0 animate-slide-in-left animation-delay-1200 text-center">
                Innovation Specialist
              </span>
              <span className="hidden sm:block text-blue-400 animate-pulse">•</span>
              <span className="px-3 sm:px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 hover:bg-white/20 hover:border-purple-400/50 transform hover:scale-105 transition-all duration-300 opacity-0 animate-slide-in-right animation-delay-1200 text-center">
                Digital Craftsman
              </span>
            </div>
          </div>
          ...
          {/* Welcome Message */}
          <p className="text-base sm:text-lg md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed opacity-0 animate-fade-in animation-delay-1500 hover:text-gray-300 transition-colors duration-300 px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center opacity-0 animate-fade-in-up animation-delay-1800 px-4">
            <button className="px-6 sm:px-8 py-3 bg-gradient-to-r cursor-pointer from-blue-500 to-purple-600 text-white rounded-full font-semibold hover:from-blue-600 hover:to-purple-700 transform hover:scale-105 sm:hover:scale-110 hover:-translate-y-1 transition-all duration-300 shadow-lg hover:shadow-2xl hover:shadow-blue-500/25 animate-float text-sm sm:text-base">
              View My Work
            </button>
            <button 
              onClick={() => document.getElementById('contact-section')?.scrollIntoView({ behavior: 'smooth' })}
